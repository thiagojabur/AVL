public class AVL {
	...
	public int getBalanceFactor(Node node) {
		int bf =0, ladoEsquerdo =0,  ladoDireito=0;
		
		if (node.getNodeLeft() != null) {
			ladoEsquerdo = node.getNodeLeft().getHeight(); 
		}
		
		if (node.getNodeRight() != null) {
			ladoDireito = node.getNodeRight().getHeight();
		}
			
		bf = ladoEsquerdo - ladoDireito;
	...
	private void insert(int value, Node root) {
		...
		if (root.getNodeLeft() == null 
			...
			root.setHeight(findDepth(root.getValue()));
			System.out.println("atualizou no primeiro- if a altura do " + root.getValue() + " para " + root.getHeight());	
		...
		if (root.getNodeRight() == null 
			...
			root.setHeight(findDepth(root.getValue()));
			System.out.println("atualizou no segundo* if a altura do " + root.getValue() + " para " + root.getHeight());		
		...
		if (value < root.getValue()) {
			root.setHeight(findDepth(root.getValue())+1);
			insert(value, root.getNodeLeft());	
            System.out.println("atualizou no segundo if a altura do " + root.getValue() + " para " + root.getHeight());		
		}
		else {
			root.setHeight(findDepth(root.getValue())+1);
			System.out.println("atualizou no else a altura do " + root.getValue() + " para " + root.getHeight());		
	...
	public int findDepth (int value) {
		return findDepth(search(value, root)); 
	}
